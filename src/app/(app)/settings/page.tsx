                        ...
                        <CardContent className="p-10 space-y-10">
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
                                {[
                                    ...
                                    <div key={idx} className="p-6 rounded-[2rem] bg-black/20 border border-white/5 text-center transition-all hover:scale-105 hover:bg-black/30 hover:border-primary/20 group">
                                        <p className="text-[9px] font-black uppercase text-muted-foreground/40 tracking-[0.2em] mb-3 group-hover:text-primary transition-colors">{item.label}</p>
                                ...
                                <div className="p-10 rounded-[2.5rem] bg-muted/10 border border-white/5 space-y-8 relative overflow-hidden group">
                                    ...
                                    <div className="flex justify-between items-end relative z-10">
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-sm text-muted-foreground font-medium italic">Occupation réelle dans le cache sécurisé du navigateur.</p>
                                        </div>
                    ...
                    <Card className="rounded-[2.5rem] border-destructive/20 bg-destructive/5 overflow-hidden group">
                        ...
                        <CardContent className="p-8 space-y-6">
                            ...
                            <div className="relative group/btn">
                                <div className="absolute -inset-1 bg-destructive/20 rounded-2xl blur opacity-0 group-hover/btn:opacity-100 transition duration-500"></div>
                                <Button 
                                    variant="outline" 
                                    onClick={() => setIsResetConfirmOpen(true)}
                                    className="relative w-full rounded-2xl h-16 border-destructive/30 bg-background/50 text-destructive hover:bg-destructive hover:text-white transition-all duration-500 font-black text-[10px] uppercase tracking-[0.2em] gap-3 shadow-xl"
                                >
