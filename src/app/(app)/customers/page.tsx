            ...
            return (
                ...
                >
                    <div className="flex gap-2 justify-center">
                        ...
                        <Button onClick={() => { setSelectedCustomer(null); setIsCustomerDialogOpen(true); }} className="rounded-xl shadow-lg shadow-sm">
        ...
        <div className="p-4 sm:p-6 space-y-6 max-w-[1600px] mx-auto">
            ...
            >
                <div className="flex gap-2 w-full sm:w-auto">
                    ...
                    <Button onClick={() => { setSelectedCustomer(null); setIsCustomerDialogOpen(true); }} className="rounded-xl font-bold shadow-lg shadow-sm">
