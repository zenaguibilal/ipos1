...
export default function CustomerDetailPage() {
    ...
    if (customer === undefined) {
        return (
             <div className="p-4 space-y-4 max-w-[1600px] mx-auto animate-pulse">
    ...
    if (!customer) {
        return (
            <div className="p-20 text-center flex flex-col items-center gap-6">
                ...
                <Button asChild variant="outline" className="rounded-2xl h-14 px-4 font-bold border-white/5 bg-card/40">
            ...
            <div className="grid lg:grid-cols-12 gap-4 items-start">
                ...
                <div className="lg:col-span-4 space-y-4 sticky top-24">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <Button 
                            size="lg" 
                            className="w-full rounded-lg h-20 font-semibold shadow-sm shadow-sm gap-3 text-[10px] uppercase tracking-wide transition-all active:scale-95"
