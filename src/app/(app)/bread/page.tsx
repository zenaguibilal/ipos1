...
export default function BreadPage() {
    ...
    return (
        <div className="p-6 sm:p-4 space-y-4 max-w-[1800px] mx-auto animate-in fade-in duration-1000">
                    ...
                    <div className="flex gap-1.5 bg-black/20 p-1.5 rounded-2xl border border-white/5 shadow-inner">
                        ...
                        <Button 
                            ...
                            className={cn(
                                ...
                                isToday ? "bg-primary text-primary-foreground shadow-lg shadow-sm" : "hover:text-primary"
                            )}
                        >
            ...
            <div className="grid lg:col-span-12 gap-4 items-stretch flex-grow min-h-0">
                {/* Distribution View */}
