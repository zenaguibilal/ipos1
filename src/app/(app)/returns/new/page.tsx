...
export default function NewReturnPage() {
    ...
    return (
        <div className="p-6 sm:p-4 space-y-4 max-w-[1200px] mx-auto animate-in fade-in duration-1000">
            <div className="flex items-center gap-4">
                 <Button variant="outline" size="icon" className="h-9 w-14 rounded-2xl border-white/5 bg-card/40 backdrop-blur-md" asChild>
                 ...
                 {foundSale && (
                    <Button 
                        ...
                        className="ml-auto h-9 px-4 rounded-2xl font-semibold text-xs uppercase tracking-wide shadow-xl shadow-sm transition-all active:scale-95 gap-3"
                    >
            ...
            <Card className={cn(
                "rounded-lg border-none shadow-sm bg-card/40 backdrop-blur-sm overflow-hidden transition-all duration-700",
                ...
                <CardHeader className="bg-primary/5 p-4 border-b border-white/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <CardTitle className="text-xl font-semibold tracking-tighter">1. Localiser la Vente Originale</CardTitle>
                            <CardDescription className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground/60">Saisissez l'identifiant de la facture pour commencer</CardDescription>
                        </div>
                    </div>
                </CardHeader>
                    ...
                    <div className="flex gap-4">
                        <div className="relative flex-grow group">
                            ...
                            <Input
                                ...
                                className="pl-14 h-9 text-xl font-semibold rounded-2xl bg-black/20 border-none shadow-inner focus-visible:ring-primary/20"
                                value={invoiceNumber}
                        ...
                        <Button 
                            ...
                            className="h-9 px-4 rounded-2xl font-semibold text-base shadow-xl shadow-sm"
                        >
            ...
            {foundSale && (
                 <div className="grid lg:grid-cols-12 gap-3 items-start animate-in slide-in-from-bottom-10 duration-1000">
                    
                    {/* Step 2: Items Selection Table */}
                    <div className="lg:col-span-8 space-y-4">
                        <Card className="rounded-lg bg-card/40 backdrop-blur-sm border-white/5 overflow-hidden shadow-sm">
                            <CardHeader className="bg-muted/20 p-4 border-b border-white/5 flex flex-row items-center justify-between">
                                <div>
                                    <CardTitle className="text-xl font-semibold tracking-tighter">2. Manifeste des Articles</CardTitle>
                                    <CardDescription className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground/60">Sélectionnez les quantités à réintégrer</CardDescription>
                                </div>
                                <div className="px-4 py-2 bg-primary/5 border border-primary/10 rounded-2xl flex items-center gap-3">
                                    <User className="h-4 w-4 text-primary" />
                                    <span className="text-[10px] font-semibold uppercase tracking-wide text-primary">{foundSale.customerUuid ? 'Client Premium' : 'Client de passage'}</span>
                                </div>
                            </CardHeader>
                            <CardContent className="p-0">
                                <div className="overflow-x-auto">
                                    <table className="w-full">
                                        <thead>
                                            <tr className="bg-muted/30 text-[10px] font-semibold uppercase text-muted-foreground/60 border-b border-white/5">
                                                ...
                                                <tr key={(item.productUuid || `custom-${index}`) + index} className="hover:bg-primary/5 transition-colors group">
                                                    <td className="p-6">
                                                        <div className="flex flex-col">
                                                            <span className="font-semibold text-sm tracking-tight group-hover:text-primary transition-colors">{item.productName}</span>
                                                            <span className="text-[9px] text-muted-foreground/40 uppercase font-semibold tracking-wide">Article d'origine</span>
                                                        </div>
                                                    </td>
                                                    <td className="p-6 text-center">
                                                        <div className="inline-flex items-center justify-center px-3 py-1 rounded-xl bg-black/20 border border-white/5 font-mono font-semibold text-xs">
                                                    ...
                                                    <td className="p-6">
                                                        <div className="relative">
                                                            <Input 
                                                                type="number" 
                                                                className="h-12 text-center font-semibold text-xl text-primary bg-primary/5 border-none shadow-inner rounded-xl focus-visible:ring-primary" 
                                                    ...
                                                    <td className="p-6 text-right font-semibold text-sm tracking-tighter">
                        ...
                        <Card className="rounded-lg bg-card/40 backdrop-blur-sm border-white/5 overflow-hidden shadow-sm">
                            <CardHeader className="bg-primary/5 p-4 border-b border-white/5">
                                <div className="flex items-center gap-4">
                                    ...
                                    <CardTitle className="text-xl font-semibold tracking-tighter">3. Finalisation</CardTitle>
                                </div>
                            </CardHeader>
                            <CardContent className="p-4 space-y-4">
                                <div className="space-y-4">
                                    <Label htmlFor="amountRefunded" className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground ml-1">Remboursement Espèces (DA)</Label>
                                    <div className="relative group">
                                        <Input
                                            ...
                                            placeholder="0.0"
                                            className="h-9 text-xl font-semibold text-center rounded-2xl bg-black/20 border-none shadow-inner focus-visible:ring-primary/20"
                                        />
                                        <div className="absolute right-6 top-1/2 -translate-y-1/2 font-semibold text-xs opacity-20 uppercase tracking-wide">DA</div>
                                    </div>
                                ...
                                <div className="p-6 rounded-lg bg-black/40 border border-white/5 space-y-6 relative overflow-hidden">
                                    <div className="absolute -right-6 -bottom-6 opacity-[0.03] rotate-12">
                                        <Landmark className="h-32 w-32" />
                                    </div>
                                    <div className="space-y-1 relative z-10">
                                        <p className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground opacity-40">Impact sur le Solde</p>
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="notes" className="text-[10px] font-semibold uppercase tracking-wide text-muted-foreground ml-1">Motif du Retour</Label>
                                    <Textarea
                                        id="notes"
                                ...
                                <Button 
                                    className="w-full h-9 rounded-lg font-semibold text-lg shadow-xl shadow-sm transition-all active:scale-95 gap-3"
                                    disabled={isSaving || !hasItemsToReturn}
                                    onClick={handleSaveReturn}
                                >
