                        ...
                        return (
                            ...
                            >
                                ...
                                <TableCell className="p-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex flex-col -space-y-0.5">
                                            <span className="font-semibold text-base tracking-tighter group-hover:text-primary transition-colors">{product.name}</span>
                                            <div className="flex items-center gap-2 mt-1">
                                                {product.supplierUuid && (
                                                    <span className="text-[9px] font-semibold uppercase text-muted-foreground/40 flex items-center gap-1 tracking-wide">
                                ...
                                <TableCell className="p-6 text-center">
                                    {expirationStatus ? (
                                        <Badge variant="outline" className={cn("text-[8px] font-semibold uppercase h-6 px-3 border-none shadow-sm", expirationStatus.color, expirationStatus.bg)}>
                                            {expirationStatus.text}
                                        </Badge>
                                    ) : (
                                        <Badge variant="outline" className="text-[8px] font-semibold uppercase h-6 px-3 text-muted-foreground/20 border-white/5 bg-black/20">STABLE</Badge>
                                    )}
                                </TableCell>
                                <TableCell className="p-6">
                                    <div className="flex items-center gap-3">
                                        <div className={cn(
                                            "inline-flex items-center justify-center px-4 py-1.5 rounded-2xl font-mono font-semibold text-sm shadow-inner border transition-all",
                                        ...
                                        <span className="text-[9px] text-muted-foreground/30 uppercase font-semibold tracking-tighter">{product.unite}</span>
                                    </div>
                                </TableCell>
