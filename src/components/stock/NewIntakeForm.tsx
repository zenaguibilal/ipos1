...
export function NewIntakeForm() {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (success) {
                toast.success("Manifeste validé. Stock et dettes mis à jour.");
                router.push('/stock');
            }
        } catch (error: any) {
                ...
                <Card className="app-card rounded-lg border-white/5 bg-card/40 backdrop-blur-sm overflow-hidden shadow-sm">
                    <CardHeader className="bg-muted/20 border-b border-white/5 p-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <CardTitle className="text-lg font-semibold tracking-tight">Registre des Flux Entrants</CardTitle>
                        </div>
                    ...
                    <CardContent className="p-6 space-y-6">
                        <div className="space-y-4">
                            <div className="space-y-2">
                                <Label className="text-[10px] font-semibold uppercase text-muted-foreground/60 ml-1">Fournisseur *</Label>
                            ...
                            <div className="grid grid-cols-1 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Input 
                                        ...
                                        className="h-11 rounded-xl bg-black/20 border-none shadow-inner font-mono font-bold"
                                        value={invoiceNumber}
                                        onChange={e => setInvoiceNumber(e.target.value)}
                                    />
                                </div>
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-semibold uppercase text-muted-foreground/60 ml-1">Date</Label>
